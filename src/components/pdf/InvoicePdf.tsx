...
const styles = StyleSheet.create({
	...
	muted: { color: "#64748b" },
	chip: { fontSize: 9, paddingHorizontal: 6, paddingVertical: 3, backgroundColor: "#0f172a", color: "#fff" },
	brandHeader: { backgroundColor: "#fcf300", paddingHorizontal: 14, paddingVertical: 10, marginBottom: 14 },
    brandTitle: { fontSize: 14, fontWeight: 700 },
	brandPill: { fontSize: 9, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: "#0f172a", color: "#fff" },
	header: { marginBottom: 20 },
	logo: { width: 120, height: 22, objectFit: "contain" },
	grid: { flexDirection: "row", gap: 16 },
	card: { borderWidth: 1, borderColor: "#e2e8f0", padding: 12 },
	label: { color: "#64748b" },
